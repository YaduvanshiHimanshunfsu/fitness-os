...
export function CalendarCard({ heatmap, currentStreak }: CalendarCardProps) {
  ...
  return (
    <div className="bg-[#0A0A0A]/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl relative overflow-hidden">
      {/* Streak Header */}
          ...
          return (
            <div 
              ...
              className={`aspect-square rounded-lg flex items-center justify-center text-xs font-bold transition-all relative group ${
                ...
                isWorkoutDay ? 'bg-gradient-to-tr from-[#FF4500] to-[#FF8C61] text-white shadow-[0_0_15px_rgba(255,69,0,0.3)] border border-[#FF4500]/50' : 
