  ...
  return (
    <div className="min-h-[80vh] flex flex-col justify-center items-center py-6">
      ...
      >
        ...
        {/* Next Exercise Panel */}
        <div className="w-full bg-zinc-950 p-4 rounded-xl border border-zinc-900 text-center mb-8">
          <span className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest block">
            Up Next
          </span>
          <span className="text-sm font-black text-white uppercase tracking-tight block mt-1 leading-snug">
            {nextExerciseName}
          </span>
        </div>
