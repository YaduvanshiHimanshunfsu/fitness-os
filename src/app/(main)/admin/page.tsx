...
import { getMuscleFocusExercises } from '@/actions/muscleFocus'
import { getAllAuxiliaryRoutines } from '@/actions/routines'
...
export default async function AdminPage() {
  ...
  const initialMuscleFocus = await getMuscleFocusExercises()
  const initialAuxiliaryRoutines = await getAllAuxiliaryRoutines()
