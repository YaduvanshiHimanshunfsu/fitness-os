  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-8 pb-24">
      <div className="pb-6 border-b border-zinc-800 mb-8">
        <h1 className="text-2xl font-bold tracking-widest uppercase text-white mb-2">Reports</h1>
        <p className="text-sm font-medium text-zinc-400">Deep dive into your performance metrics</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Link href="/reports/weekly" className="group block">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 transition-all duration-300 group-hover:scale-[1.02] group-hover:border-zinc-600 group-hover:shadow-lg group-hover:shadow-black/50 h-full flex flex-col">
            <div className="mb-4 text-zinc-400 group-hover:text-white transition-colors">
              <Activity className="w-8 h-8" />
            </div>
            <h2 className="text-lg font-bold tracking-widest uppercase text-white mb-2">Weekly Report</h2>
            ...
            <div className="flex items-center text-xs font-bold uppercase tracking-widest text-zinc-400 group-hover:text-zinc-100 transition-colors">
        ...
        <Link href="/reports/monthly" className="group block">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 transition-all duration-300 group-hover:scale-[1.02] group-hover:border-zinc-600 group-hover:shadow-lg group-hover:shadow-black/50 h-full flex flex-col">
            ...
            <h2 className="text-lg font-bold tracking-widest uppercase text-white mb-2">Monthly Report</h2>
        ...
        <Link href="/reports/yearly" className="group block">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 transition-all duration-300 group-hover:scale-[1.02] group-hover:border-zinc-600 group-hover:shadow-lg group-hover:shadow-black/50 h-full flex flex-col">
            ...
            <h2 className="text-lg font-bold tracking-widest uppercase text-white mb-2">Yearly Report</h2>
