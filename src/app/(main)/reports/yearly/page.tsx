    ...
    <div className="max-w-5xl mx-auto p-4 sm:p-8 pb-24">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 flex flex-col items-center justify-center">
          ...
          <span className="text-3xl font-bold text-white">{report.totalWorkouts}</span>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 flex flex-col items-center justify-center">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 flex flex-col items-center justify-center">
          ...
          <span className="text-3xl font-bold text-white">{report.totalActiveHours} <span className="text-sm text-zinc-500">hrs</span></span>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 flex flex-col items-center justify-center">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 flex flex-col items-center justify-center">
          ...
          <span className="text-xl font-bold text-white text-center leading-tight mt-1">{report.levelReached}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <div className="md:col-span-1 bg-zinc-900 border border-zinc-800 rounded-xl p-6 flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
          ...
          <span className="text-xl font-bold text-white block mb-1">{report.bestMonth}</span>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
          <span className="text-[10px] tracking-widest uppercase text-zinc-500 font-bold block mb-2">Top Muscle</span>
          <span className="text-xl font-bold text-white block mb-1">{report.topMuscleGroup}</span>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
          <span className="text-[10px] tracking-widest uppercase text-amber-500 font-bold block mb-2">Longest Streak</span>
          <span className="text-xl font-bold text-white block mb-1">{report.longestStreak} days</span>
        </div>
      </div>

      <Link href="/dashboard" className="block">
        <div className="bg-zinc-800 hover:bg-zinc-700 hover:scale-[1.01] transition-all border border-zinc-600 hover:border-zinc-500 rounded-xl p-6 text-center shadow-lg shadow-black/50">
          <span className="text-sm font-bold tracking-widest uppercase text-zinc-100 flex items-center justify-center gap-2">
